...
export default function SnakeGame({ speed, paused, sessionKey, onStats }: Props) {
  ...
  useEffect(()=>{
    ...
    const size=16,cols=34,rows=15,ox=(c.width-cols*size)/2,oy=30;
