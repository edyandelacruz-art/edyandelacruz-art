...
const STOPWORDS = new Set([
  'para','como','entre','desde','hasta','sobre','porque','cuando','donde','estas','estos','esta','este','tambien','mediante','puede','pueden','tiene','tienen','una','unos','unas','del','las','los','que','con','por','sin','sus','más','muy','the','and','with','from','that','this','into','through','their','which','while',
]);
